...
import { 
  ...
  FaMedkit, FaPalette, FaIndustry, FaGavel, FaLeaf,
  FaShieldAlt, FaVideo, FaTruck, FaHandsHelping,
  FaFlask, FaGraduationCap
} from 'react-icons/fa';
...
export const jobCategories = {
  ...
  "Art & Design": {
    name: "Art & Design",
    icon: FaPalette,
    description: "Professional art and design services for all mediums",
    subcategories: [
      "Graphic Design",
      "Logo Design",
      "Brand Identity Design",
  ...
  "Manufacturing": {
    name: "Manufacturing",
    icon: FaIndustry,
    description: "Professional manufacturing services for businesses",
    subcategories: [
      "Custom Manufacturing",
      "Metal Fabrication",
      "Plastic Manufacturing",
  ...
  "Legal": {
    name: "Legal",
    icon: FaGavel,
    description: "Professional legal services for individuals and businesses",
    subcategories: [
      "Corporate Law",
      "Criminal Law",
      "Family Law",
  ...
  "Environmental": {
    name: "Environmental",
    icon: FaLeaf,
    description: "Professional environmental services for businesses and individuals",
    subcategories: [
      "Environmental Consulting",
      "Waste Management",
      "Recycling Services",
  ...
  "Security": {
    name: "Security",
    icon: FaShieldAlt,
    description: "Professional security services for businesses and individuals",
    subcategories: [
      "Security Guards",
      "CCTV Installation",
      "Access Control Systems",
  ...
  "Media Production": {
    ...
    icon: FaVideo,
    description: "Professional media production services for businesses and individuals",
    subcategories: [
      "Film Production",
      "Video Production",
      "Music Production",
  ...
  "Logistics": {
    name: "Logistics",
    icon: FaTruck,
    description: "Professional logistics services for businesses and individuals",
    subcategories: [
      "Freight Transport",
      "Courier Services",
      "Logistics Management",
